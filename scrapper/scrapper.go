...
func Scrape(term string) {
	var baseUrl string = "https://www.saramin.co.kr/zf_user/search/recruit?=&searchword=" + term + "&recruitPageCount=10"
...
func getPage(baseUrl string, pageNumber int, mainC chan<- []extractedJob) {
	var jobs []extractedJob
	c := make(chan extractedJob)
